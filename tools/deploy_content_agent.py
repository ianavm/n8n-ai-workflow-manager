  ...
  json: {
    ...
    nodes.append({
        "parameters": {
            ...
            "columns": {
                "value": {
                    "Topic": "=AI Recommendations - {{ $now.toFormat('yyyy-MM-dd') }}",
    ...
    nodes.append({
        "parameters": {
            "sendTo": ALERT_EMAIL,
            "subject": "=AVM Content Performance Insights - {{ $now.toFormat('yyyy-MM-dd') }}",
            "emailType": "html",
...
<p style="color: white; margin: 5px 0;">30-Day Analysis | {{ $now.toFormat('yyyy-MM-dd') }}</p>
</div>
...
Generated by AVM Content Agent | {{ $now.toFormat('yyyy-MM-dd HH:mm') }}
</div>
</div>""",
            "options": {},
        },
