...
export const metadata = {
  title: "Privacy Policy · AnyVision Media",
  description:
    "How AnyVision Media collects, uses, and protects your personal information under POPIA.",
};
  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <div className="flex gap-4 text-sm text-[#52525B]">
        <Link href="/legal/terms" className="hover:text-[#71717A] no-underline">
