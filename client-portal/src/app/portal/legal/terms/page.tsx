  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <div className="glass-card p-8 space-y-6 text-sm text-[#A1A1AA] leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            <Link href="/portal/legal/privacy" className="text-[#6366F1] no-underline hover:underline">
              Privacy Policy
            </Link>.
      ...
      <div className="flex gap-4 text-sm text-[#52525B]">
        <Link href="/portal/legal/privacy" className="hover:text-[#71717A] no-underline">
          Privacy Policy &rarr;
        </Link>
